...
void main() {
  ...
  group('ProfileRepository', () {
    ...
    group('updateProfile', () {
      test('should return ProfileDomain when repository call is successful',
          () async {
        // Arrange
        final profileId = '123';
        ...
        when(mockProfileRepository.updateProfile(
                profileForm: profileForm, profileId: profileId))
      ...
      test(
          'should return ProfileFailure.serverError when repository call fails',
          () async {
        // Arrange
        final profileId = '123';
        final profileForm = ProfileForm(
    ...
    // Test for successful profile fetch
    group('getProfile', () {
      test('should return ProfileDomain when repository call is successful',
          () async {
        // Arrange
