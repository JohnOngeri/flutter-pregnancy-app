...
void main() {
  ...
  // Set up the mock repository and the repository under test
  setUp(() {
    mockTipRepository = MockTipRepository();
    tipRepository = TipRepository(mockTipRepository as TipAPI);
  });

  group('TipRepository Tests', () {
    group('addTip', () {
      test('should return TipDomain when repository call is successful',
          () async {
        // Arrange
        final tipForm =
            TipForm(title: 'Tip 1', body: 'This is a tip', type: '');
        final tipDomain =
      ...
      test('should return TipFailure.serverError when repository call fails',
          () async {
        // Arrange
        final tipForm =
            TipForm(title: 'Tip 1', body: 'This is a tip', type: '');
    ...
    group('updateTip', () {
      test('should return TipDomain when repository call is successful',
        ...
        final tipId = '1';
        final tipForm =
            TipForm(title: 'Updated Tip', body: 'This is a tip', type: '');
        final tipDomain = TipDomain(
            id: '1', title: 'Updated Tip', body: 'This is a tip', type: '');
        ...
        // Act
        final result =
            await tipRepository.updateTip(tipForm: tipForm, tipId: tipId);

        // Assert
        expect(result, equals(right(tipDomain)));
        verify(mockTipRepository.updateTip(tipForm: tipForm, tipId: tipId))
            .called(1);
      });
    ...
    group('getTipsByType', () {
      test('should return List<TipDomain> when repository call is successful',
          () async {
        // Arrange
        final type = 'type1';
        final tips = [
    ...
    group('getTips', () {
      test('should return List<TipDomain> when repository call is successful',
        ...
        when(mockTipRepository.getTips()).thenAnswer((_) async => right(tips));
